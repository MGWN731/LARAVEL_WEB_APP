<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            ...
            <a href="{{ route('employees.show', $employee) }}" class="text-sm font-semibold text-blue-700 hover:underline">Back</a>
        </div>
    </x-slot>
    ...
    <div class="py-10">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white border border-slate-200 rounded-lg shadow-sm p-6">
                <form method="POST" action="{{ route('employees.update', $employee) }}" enctype="multipart/form-data" class="space-y-4">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input id="job_title" name="job_title" type="text" value="{{ old('job_title', $employee->job_title) }}"
                                   class="mt-1 block w-full rounded-md border-slate-300 focus:border-blue-500 focus:ring-blue-500" />
                        ...
                        <div>
                            ...
                            <input id="salary" name="salary" type="number" step="0.01" value="{{ old('salary', $employee->salary) }}"
                                   class="mt-1 block w-full rounded-md border-slate-300 focus:border-blue-500 focus:ring-blue-500" />
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input id="hire_date" name="hire_date" type="date" value="{{ old('hire_date', optional($employee->hire_date)->format('Y-m-d')) }}"
                                   class="mt-1 block w-full rounded-md border-slate-300 focus:border-blue-500 focus:ring-blue-500" />
                    ...
                    <div>
                        ...
                        <textarea id="notes" name="notes" rows="4" class="mt-1 block w-full rounded-md border-slate-300 focus:border-blue-500 focus:ring-blue-500">{{ old('notes', $employee->notes) }}</textarea>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <a href="{{ route('employees.show', $employee) }}" class="text-sm font-semibold text-slate-700 hover:underline">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
