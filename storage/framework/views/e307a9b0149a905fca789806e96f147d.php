...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex items-center justify-between text-sm">
            <a href="<?php echo e(route('password.request')); ?>" class="font-semibold text-blue-700 hover:underline">Forgot password?</a>
            <a href="<?php echo e(route('register')); ?>" class="font-semibold text-slate-700 hover:underline">Create account</a>
        </div>
    </form>
...
<?php endif; ?>
<?php /**PATH C:\lara_EmployeeManagementSystem\resources\views\auth\login.blade.php ENDPATH**/ ?>