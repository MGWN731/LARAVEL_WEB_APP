...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-sm text-slate-700">
            ...
            <a href="<?php echo e(route('login')); ?>" class="font-semibold text-blue-700 hover:underline">Log in</a>
        </div>
    </form>
...
<?php endif; ?>
<?php /**PATH C:\lara_EmployeeManagementSystem\resources\views\auth\register.blade.php ENDPATH**/ ?>