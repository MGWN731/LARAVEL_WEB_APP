...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-sm">
            <a href="<?php echo e(route('login')); ?>" class="font-semibold text-blue-700 hover:underline">Back to login</a>
        </div>
    </form>
...
<?php endif; ?>
<?php /**PATH C:\lara_EmployeeManagementSystem\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>