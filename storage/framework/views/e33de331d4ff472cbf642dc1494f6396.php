            ...
            <footer class="bg-white border-t border-slate-200">
                <div class="flex flex-col items-center justify-between gap-4 px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8 sm:flex-row sm:text-left text-center">
                    ...
                    <div class="flex items-center gap-4">
                        <a href="<?php echo e(route('about')); ?>" class="text-sm text-slate-600 hover:text-slate-900">About</a>
...
<?php /**PATH C:\lara_EmployeeManagementSystem\resources\views\welcome.blade.php ENDPATH**/ ?>